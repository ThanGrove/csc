...
<div class="csc-3col-container"><div class="csc-3col-wrapper">
  ...
  <div class="csc-3col-col-fluid">
    <div class="csc-3col-inside-inside"><?php print $content['fluid1']; ?></div>
  </div>
  <div class="csc-3col-col-fluid">
    <div class="csc-3col-inside-inside"><?php print $content['fluid2']; ?></div>
  </div>
</div></div>